...
- The backend suite passes (`158 passed`). The frontend passes TypeScript checking, ten Vitest tests, and the full production Vite build (verified outside the desktop filesystem restriction used by esbuild).
